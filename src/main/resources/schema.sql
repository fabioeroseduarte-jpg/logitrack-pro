...
-- 3. Criação da Tabela de Manutenção
...
-- Inserindo Manutenção (Para testar o Cronograma e Custos)
INSERT INTO manutencao (veiculo_id, data_inicio, data_finalizacao, tipo_servico, custo_estimado, status) VALUES 
